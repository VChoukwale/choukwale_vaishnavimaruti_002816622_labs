...
//        layout.next(userProcessContainer);
    ...
    private void btnSupplierProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSupplierProfileActionPerformed
        // TODO add your handling code here:
        // Create an instance of UpdateProfileJPanel
        UpdateProfileJPanel updateProfilePanel = new UpdateProfileJPanel(supplier);

        // Add the UpdateProfileJPanel to the workArea
        workArea.add("UpdateProfileJPanel", updateProfilePanel);

        // Switch to the UpdateProfileJPanel
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.show(workArea, "UpdateProfileJPanel");
